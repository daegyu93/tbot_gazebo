...
def generate_launch_description():
    ...
    tbot_gps_nav2_dir = get_package_share_directory("tbot_gazebo")
    launch_dir = os.path.join(tbot_gps_nav2_dir, 'launch')
    world = os.path.join(tbot_gps_nav2_dir, "worlds", "sonoma_raceway.world")

    urdf = os.path.join(tbot_gps_nav2_dir, 'urdf', 'turtlebot3_waffle_gps.urdf')
    with open(urdf, 'r') as infp:
        robot_description = infp.read()

    models_dir = os.path.join(tbot_gps_nav2_dir, "models")
